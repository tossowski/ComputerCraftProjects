...
class Textures(object):
    ...
    def get_canvas_texture(self, c):
        # print(self.blockmap[4410][0])
        # return self.blockmap[4410]
        # print("yoooo")
        # print(c)
        image = numpy.ones((16,16,3), dtype=numpy.uint8) * 255
        if c == 2 ** 30:
            image = Image.fromarray(image).convert("RGBA")
            iso_image = self.build_block(image, image)
            return (iso_image, self.generate_opaque_mask(iso_image))
        r = c >> 16
        c -= r * 65536
        g = c // 256
        c -= g * 256
...
# Modded oak wood
#block(blockid=[3188], top_image="assets/futureminecraf/textures/blocks/log_oak.png", modname="FutureVersions+v1.3.0.2")

block(blockid=[3067], top_image="assets/futureminecraf/textures/blocks/log_oak.png", modname="FutureVersions+v1.3.0.2")


# OP Canvas Hack

# For My World
#block(blockid=[589], top_image="assets/openblocks/textures/blocks/canvas.png", modname="OpenBlocks-1.12.2-1.8.1")

# For big world
block(blockid=[483], top_image="assets/openblocks/textures/blocks/canvas.png", modname="OpenBlocks-1.12.2-1.8.1")
